<#
.SYNOPSIS
    Empaqueta y genera el archivo ZIP de una nueva versión de Punto de Venta para subir a GitHub Releases.

.DESCRIPTION
    1. Compila y publica la aplicación WPF en modo Release (win-x64, autocontenida).
...
Write-Host "========================================================" -ForegroundColor Cyan
Write-Host "Versión a compilar: v$Version" -ForegroundColor Green
...
Write-Host "4. En la descripción escribe las novedades (ej: 'Mejoras en el cierre de caja y ventas')" -ForegroundColor White
...
Write-Host "detectará la nueva versión v$Version automáticamente y ofrecerá actualizar con 1 clic." -ForegroundColor Cyan
